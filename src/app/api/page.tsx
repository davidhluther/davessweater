...
export default async function ApiDocsPage() {
  ...
  return (
    <SectionBand>
      ...
      <h1 className="ds-h1 text-foreground">Free Data and API</h1>
      ...
      <div className="mt-6 rounded-2xl border border-border bg-surface p-5">
        <h2 className="ds-h3 text-foreground">License and attribution</h2>
        <p className="mt-2 ds-body text-muted">
      ...
      {/* JSON API */}
      <h2 className="mt-8 ds-h2 text-foreground">JSON API</h2>
      ...
      <div className="mt-4 space-y-3">
        {ENDPOINTS.map((e) => (
          <div key={e.path} className="rounded-2xl border border-border bg-background p-4">
            ...
            <p className="mt-1.5 ds-body text-muted">{e.desc}</p>
      ...
      {/* Widget */}
      <h2 className="mt-8 ds-h2 text-foreground">Embeddable widget</h2>
      <p className="mt-1 ds-body text-muted">
